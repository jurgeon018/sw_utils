# ADMIN_TOOLS_INDEX_DASHBOARD = 'sw_admin.dashboard.CustomIndexDashboard'
# or
ADMIN_TOOLS_INDEX_DASHBOARD = {
    # 'django.contrib.admin.site': 'admin_tools.dashboard.dashboards.DefaultIndexDashboard',
    'django.contrib.admin.site': 'sw_admin.dashboard.CustomIndexDashboard',
...
# ADMIN_TOOLS_APP_INDEX_DASHBOARD = 'sw_admin.dashboard.CustomAppIndexDashboard'
# or
ADMIN_TOOLS_APP_INDEX_DASHBOARD = {
    # 'django.contrib.admin.site': 'admin_tools.dashboard.dashboards.DefaultAppIndexDashboard',
    'django.contrib.admin.site': 'sw_admin.dashboard.CustomAppIndexDashboard',
...
# ADMIN_TOOLS_MENU = 'sw_admin.menu.CustomMenu'
# or
ADMIN_TOOLS_MENU = {
    # 'django.contrib.admin.site': 'admin_tools.menu.DefaultMenu',
    'django.contrib.admin.site': 'sw_admin.menu.CustomMenu',
